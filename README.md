...
- [`shop-voice-checkin`](skills/shop-voice-checkin/) - Consent-based morning inventory and evening sales phone check-ins for informal retailers using Pidgin-influenced or plain English; returns structured shop data with a demo-first fixture path and no live call by default.
...
| [`apps/python/shop-voice-manager`](apps/python/shop-voice-manager/) | Python | Demo-first voice business manager for informal retailers: morning inventory and evening sales check-ins via CALL-E task preview and fixture results, weekly summary output, no live call or API key by default. |
